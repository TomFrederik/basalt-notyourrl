...
def main(env_name, data_dir, log_dir, expert_batch_size, n_envs, total_timesteps, gen_algo_steps, verbose):
    
    # set up data loading
    data = AIRLDataset(env_name, data_dir, expert_batch_size)
    ...
    airl_trainer = adversarial.AIRL(
        ...
        gen_algo=sb3.PPO('MlpPolicy', venv, verbose=int(verbose), n_steps=gen_algo_steps)
    )
